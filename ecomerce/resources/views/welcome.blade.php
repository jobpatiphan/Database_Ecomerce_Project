        ...
        <section class="p-8" x-data="{ currentIndex: 0, productsPerPage: 2 }">
            ...
            <div class="max-w-4xl mx-auto py-12">
                ...
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('login') }}" class="inline-block px-8 py-3 bg-black text-white font-semibold rounded-full hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-opacity-50 mt-10">
                        Login now
                    </a>
                </div>
            </div>
