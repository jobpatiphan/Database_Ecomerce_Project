    ...
    <div class="min-h-screen">
        <header class="bg-white p-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('login') }}" class="text-gray-600"><svg class="w-6 h-6" fill="none"
        ...
        <main>
            <section class="bg-black text-white p-8 flex justify-between items-center">
                ...
                <img src="https://s3-alpha-sig.figma.com/img/12b6/9cdc/b388ebc0a3376cc06ca83363eb03a031?Expires=1728259200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=bfXAzW7p6ruLdWf0C6Xxks-EKJfcUtOhzcY1SOrRkhApk-aKtYR8oG~LYIl5RLP13mrrCj3AcBSCi29mIlNBN9yXNx8hvrzrDgdjPexrOfzYco2po0oVE4CTFnOnTYMs-BQ~3N-LlwgHP9kBHu13avUkrf8qkw7FjAeZ-eSQeMaldCrlCvfKGFedxF5cof3W2X8Qo5BF0xGsea~EeuZeuOuADhg5JyPiOTZLQBmsunyM9mBMDX0pI5g9hYR7dZ8hH9HbUhVGhjvv7Vb13AVK1HhEKy2uzJL6z5nlENkY0qzb50ICtpF8ISqimEQSHsUjUIaqJxUwoAG7ZPM7TVrieA__"
                    alt="Featured Shoe" class="w-80 h-80 object-contain">
            </section>
                ...
                <div class="flex justify-center mt-4">
                    <div class="flex space-x-2">
                        @if ($products->onFirstPage())
                            <span
                                class="disabled cursor-not-allowed text-gray-400 font-bold px-4 py-2 rounded bg-gray-200">&larr;
                                Previous</span>
                        @else
            ...
            <main>
                ...
                <section class="p-8" x-data="{ currentIndex: 0, productsPerPage: 2 }">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <span
                                class="disabled cursor-not-allowed text-gray-400 font-bold px-4 py-2 rounded bg-gray-200">Next
                                &rarr;</span>
                        @endif
                    </div>
                </div>
        ...
        <footer class="bg-black text-white p-8">
            <div class="flex justify-between">
                <div>
                    ...
                    <p class="text-sm mt-2">092-877-2346</p>
                    <p class="text-sm mt-2">มหาวิทยาลัยเชียงใหม่ 239 ถนนห้วยแก้ว ต.สุเทพ อ.เมือง </p>
                    <p class="text-sm mt-2">จ.เชียงใหม่ 50200 </p>
                    <p class="text-sm mt-2">โทรศัพท์ :+66 5394 1300 </p>
                    <p class="text-sm mt-2">โทรสาร : +66 5321 7143 </p>
                    <p class="text-sm mt-2">devilark2020@gmail.com</p>
                </div>
                <div>
                    <h4 class="font-bold mb-2">Information</h4>
                    <ul class="space-y-1">
                        <li><a href="{{ route('login') }}" class="text-sm">My Account</a></li>
                        <li><a href="{{ route('login') }}" class="text-sm">Login</a></li>
                        <li><a href="{{ route('login') }}" class="text-sm">My cart</a></li>
                        <li><a href="{{ route('login') }}" class="text-sm">My Wishlist</a></li>
                        <li><a href="{{ route('login') }}" class="text-sm">Checkout</a></li>
                    </ul>
                </div>
            </div>
