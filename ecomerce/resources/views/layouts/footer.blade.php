    ...
    <footer class="bg-black text-white p-8 ">
        ...
        <div class="flex justify-between">
            ...
            <div>
                ...
                <ul class="space-y-1">
                    <li><a href="{{ route('acc.view') }}" class="text-sm">My Account</a></li>
                    <li><a href="{{ route('profile.order') }}" class="text-sm">My cart</a></li>
                    <li><a href="{{ route('profile.wishList') }}" class="text-sm">My Wishlist</a></li>
                    <li><a href="{{ route('profile.order') }}" method="POST" class="text-sm">Checkout</a></li>
                </ul>
            </div>
        </div>
